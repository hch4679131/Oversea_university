(function initApartmentStore(globalFactory) {
  ...
  function createSharedYmtDetailSections() {
    return cloneValue(sharedYmtDetailSections);
  }
  ...
  const apartmentPages = {
    'apartment-ymt': {
      ...
      lifestyleCards: createSharedYmtDetailSections().lifestyleCards,
      amenityGroups: createSharedYmtDetailSections().amenityGroups,
      floorPlans: createSharedYmtDetailSections().floorPlans
    },
    'apartment-csw': {
