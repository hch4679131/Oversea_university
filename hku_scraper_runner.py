...
def main():
    ...
    logger.info('[Spiders] hku_arts_news, hku_science_news, hku_business_news, hku_grad_news')
    
    spiders = ['hku_arts_news', 'hku_science_news', 'hku_business_news', 'hku_grad_news']  # 要运行的所有爬虫
